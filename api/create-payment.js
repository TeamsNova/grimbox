...
export default function handler(req, res) {
    ...
    try {
        ...
        const paymentUrl = 'https://pay.freekassa.com/?m=' + MERCHANT_ID + '&oa=' + finalPrice + '&currency=' + currency + '&o=' + orderId + '&s=' + sign + '&i=36&us_nickname=' + encodeURIComponent(nickname) + '&us_product=' + productId + '&lang=ru';
